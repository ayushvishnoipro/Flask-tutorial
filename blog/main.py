...
@app.post("/user",status_code=status.HTTP_201_CREATED,response_model=schemas.ShowUsers,tags=["Users"])
...
@app.get("/user/{id}",status_code=200,response_model=schemas.ShowUsers,tags=["Users"])
